...
def make_args():
    ...
    parser.add_argument('--map_dir', type=str, default="data/Porto_Large/edges.shp")
    ...
    parser.add_argument('--ori_dir', type=str, default='/home/tianwei/dataset/dataset_TR/porto')
    ...
    args.train_file = os.path.join(args.ori_dir, "traj_train_{}".format(args.scale))
