...
def train_node2vec(edge_index, cell_embedding_dim, cell_size, device, checkpoint_dir):
    ...
    checkpoint_file = checkpoint_dir + '/' + '_node2vec_cell' + str(int(cell_size)) + '_best.pt'
